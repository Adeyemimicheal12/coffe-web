                    ...
                    <div className="text-lightOrange mt-[100px] md:mt-0 p-4 space-y-28">
                        ...
                        className="relative">
                            <div className="relative z-10 space-y-4">
                                ...
                                <h1 className="text-sm opacity-55 leading-loose">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quasi quos dolorem maiores exercitationem molestias nisi aperiam mollitia quae alias ex itaque eaque, eos nesciunt, error molestiae beatae ut aspernatur. Repellat?</h1>
                            </div>
